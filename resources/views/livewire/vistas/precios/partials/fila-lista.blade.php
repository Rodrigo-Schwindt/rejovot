@php $abiertaAca = $abierta === $lista->id; @endphp

<tr wire:key="lista-{{ $lista->id }}" class="border-b border-slate-100 align-middle">
...
@if($abiertaAca)
    <tr wire:key="detalle-lista-{{ $lista->id }}" class="border-b border-slate-100 bg-slate-50/60">
        <td colspan="4" class="px-4 py-5">
            <div class="rounded-[4px] border border-slate-200 bg-white px-5 py-4">
